/* The base URL path for all endpoints in this controller is "/medical-services".
 * The class uses the MedServService to handle business logic related to medical services,
 * and the MedServMapper to convert between DTOs and domain entities.
 */
